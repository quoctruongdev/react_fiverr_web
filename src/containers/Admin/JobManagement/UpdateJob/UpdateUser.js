...
import { actFetchUpdateJob } from "./modules/actions";
import Loader from "../../../../components/Loader/Loader";
export default function UpdateJob(props) {
  const loading = useSelector((state) => state.editJobReducer.loading);
  const data = useSelector((state) => state.editJobReducer.data);
  ...
  const handleUpdateJob = (e) => {
    e.preventDefault();
    dispatch(actFetchUpdateJob(props.match.params.id, update, props.history));
    if (loading) {
      <Loader />;
    }
  };
