...
export default function Feature() {
  ...
  return (
    <>
      <div className="selling-proposition px-5">
        <div className="row ">
          <div className="col-12-xs col-md-5 selling__text">
          ...
          <div className="col-12-xs col-md-7 selling__picture  ">
      ...
      <div className="modal__video">
        <ModalVideo data={data} open={open} onClose={handleClose} />
      </div>
    </>
  );
}
